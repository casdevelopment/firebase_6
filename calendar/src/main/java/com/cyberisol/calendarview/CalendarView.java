package com.cyberisol.calendarview;
...
import com.cyberisol.calendarview.adapters.CalendarPageAdapter;
import com.cyberisol.calendarview.exceptions.ErrorsMessages;
import com.cyberisol.calendarview.exceptions.OutOfDateRangeException;
import com.cyberisol.calendarview.extensions.CalendarViewPager;
import com.cyberisol.calendarview.listeners.OnCalendarPageChangeListener;
import com.cyberisol.calendarview.listeners.OnDayClickListener;
import com.cyberisol.calendarview.utils.AppearanceUtils;
import com.cyberisol.calendarview.utils.CalendarProperties;
import com.cyberisol.calendarview.utils.DateUtils;
import com.cyberisol.calendarview.utils.SelectedDay;

import java.util.Calendar;
import java.util.Date;
import java.util.List;

import static com.cyberisol.calendarview.utils.CalendarProperties.FIRST_VISIBLE_PAGE;
...
public class CalendarView extends LinearLayout {
    ...
    private void initCalendarProperties(TypedArray typedArray) {
        ...
        boolean eventsEnabled = typedArray.getBoolean(R.styleable.CalendarView_eventsEnabled, mCalendarProperties.getCalendarType() == CLASSIC);
...
//        mPreviousButton.setOnClickListener(onPreviousClickListener);
    ...
    public void setSelectedDatesWithColor(List<Calendar> selectedDates, int color) {
        mCalendarProperties.setSelectedDays(selectedDates);
    ...
    public void setNavigationVisibility(int enabled) {
        mCalendarProperties.setNavigationVisibility(enabled);
        mCalendarProperties.setNavigationVisibility(mCalendarProperties.getNavigationVisibility());
    }
}
