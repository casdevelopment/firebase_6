...
class WelcomeActivity : AppCompatActivity(), WelcomeAdapter.onItemClickListener {
    ...
    private fun displayDummyData() {
        ...
        if (packageName.equals("com.fssa.esm")){
            ...
            val studentList = parseJson(AppConstants.DummyJsonResponseAgora)
            setRecyclerView(studentList)
        }else  if (packageName.equals("com.apsgujrawala.esm")){
            val studentList = parseJson(AppConstants.DummyJsonResponseAps)
            setRecyclerView(studentList)
        }else  if (packageName.equals("com.keystoneacademy.esm")){
            val studentList = parseJson(AppConstants.DummyJsonResponsekeystone)
            setRecyclerView(studentList)
